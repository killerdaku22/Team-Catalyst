    ...
    <div className="max-w-6xl mx-auto px-6 py-10 space-y-12">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3">
          {[
            { name: 'Background',    var: '--ad-bg' },
            { name: 'Surface 0',     var: '--ad-surface-0' },
            { name: 'Surface 1',     var: '--ad-surface-1' },
            { name: 'Surface 2',     var: '--ad-surface-2' },
            { name: 'Border',        var: '--ad-border' },
            { name: 'Border Accent', var: '--ad-border-accent' },
            { name: 'Accent Gold',   var: '--ad-accent' },
            { name: 'Accent Bright', var: '--ad-accent-bright' },
            { name: 'Brand Green',   var: '--ad-brand' },
            { name: 'Brand Bright',  var: '--ad-brand-bright' },
            { name: 'Cool Slate',    var: '--ad-cool' },
            { name: 'Cool Bright',   var: '--ad-cool-bright' },
            { name: 'Text Primary',  var: '--ad-text-primary' },
            { name: 'Text Secondary',var: '--ad-text-secondary' },
            { name: 'Text Tertiary', var: '--ad-text-tertiary' },
            { name: 'Text Muted',    var: '--ad-text-muted' },
            { name: 'Danger Red',    var: '--ad-danger' },
            { name: 'Warning Gold',  var: '--ad-warning' },
          ].map(c => (

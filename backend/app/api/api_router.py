...
from app.api.endpoints import auth, marketplace, forecasting, logistics, analytics, data_management, decision, opportunity, intelligence, policy, contracts, voice_advisor, cold_storage, buffer_stock
...
api_router.include_router(buffer_stock.router, prefix="/buffer", tags=["National Buffer Stock & MIS Engine"])
